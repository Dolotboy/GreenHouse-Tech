                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30">
                        ...
                        <h3>Edit a plant</h3>
                            <div class="border-bottom pb-3 mb-3">
                                ...
                                <h3 class="mb-3"> <input type="text" name='plantState' placeholder="Plant State" value="{{ $plant["plantState"] }}" required></h3>
                                <h3 class="mb-3"> <input type="text" name='plantDifficulty' placeholder="Plant Difficulty" value="{{ $plant["plantDifficulty"] }}" required></h3>
                                <h3 class="mb-3"> <input type="text" name='lifeTime' placeholder="Life Time" value="{{ $plant["lifeTime"] }}" required></h3>
