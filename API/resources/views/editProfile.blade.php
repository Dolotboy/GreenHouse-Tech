                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30">
                        ...
                        <h3>Delete a profile</h3>
                            <div class="border-bottom pb-3 mb-3">
                                ...
                                <h3 class="mb-3"> <input type="text"  name='lastName'   value="{{ $profile["lastName"] }}" required></h3>   
                                <h3 class="mb-3"> <input type="text"  name='access'   value="{{ $profile["access"] }}" required></h3>  
                                <h3 class="mb-3"> <input type="submit" name='submit' onclick="Delete()" placeholder="Submit" value="Delete"></h3>                             
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    function Delete(){
        var idProfile ="{{ $profile["idProfile"] }}";
        let form = document.getElementById("delete").action = '../../../../api/delete/profile/' + idProfile;
    }
</script>
@endsection