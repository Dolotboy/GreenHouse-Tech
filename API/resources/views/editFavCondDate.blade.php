                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 pl-xl-0 pl-lg-0 pl-md-0 border-left m-b-30">
                        <div class="product-details">
                            ...
                            <div class="border-bottom pb-3 mb-3">
                                <h2 class="mb-3"> <input type="text" name='rangeType' value="{{ $favorableCondition["rangeType"] }}"></h2>
                                <h2 class="mb-3"> <input type="text" name='begin' value=" {{ $favorableCondition["begin"] }}"></h2>
